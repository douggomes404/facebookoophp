...
class UserRelationDaoMysql implements UserRelationDao{
    private $pdo;
        ...
        public function getFollowing($id){
            ...
            $sql = $this->pdo->prepare("SELECT usert_to FROM userrelations WHERE user_from = :user_from");
        ...
        public function getFollowers($id){
            ...
            $sql = $this->pdo->prepare("SELECT usert_from FROM userrelations WHERE user_to = :user_to");
